...
# Base config files
_C.BASE = ['']
_C.CSV_TRAIN_PATH = '/home/data1/lyj/MFM/train.csv'
_C.MODEL_FAG = 'ViTB16'
_C.MODEL_NAME = 'ViTB16'
_C.FAG_CHECKPOINT = './models/ViTB16_FAG.pth'
_C.EVAL_DATASET = './data/val.csv'
# -----------------------------------------------------------------------------
# Data settings
# -----------------------------------------------------------------------------
_C.DATA = CN()
...
_C.MODEL.RECOVER_TARGET_TYPE = 'masked'
